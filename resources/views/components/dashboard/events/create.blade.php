                ...
                <div class="card-body p-4 p-lg-5">
                    <div class="row align-items-center g-4">
                        <div class="col-lg-8">
                            ...
                            <p class="dashboard-form-subtitle">Add the event image, timing, department ownership, and description in one focused workflow.</p>
                        </div>
                        <div class="col-lg-4">
                            <div class="dashboard-form-hero-actions">
                                ...
                                <div class="dashboard-form-note"><span class="dot"></span>Preview the event image before saving</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                <x-dashboard.partials.cropped-image-field
                                    ...
                                    helper="Upload the event image, drag to choose the strongest section, then confirm the crop."
                            ...
                            <div class="col-md-6 mb-3"><label class="form-label">Video Link</label><input type="url" name="video_link" value="{{ old('video_link') }}" class="form-control"></div>
